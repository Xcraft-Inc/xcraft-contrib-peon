...
const vstest = function (cache, extra, response, callback) {
  const fs    = require ('fs');
...
module.exports = function (data, extra, response, callback) {
  vstest (data.fullLocation, extra, response, callback);
};
