...
exports.scripts = function (ctx, namespace) {
  const {pkgProductsRoot} = xConfig;
  const location = path.join(pkgProductsRoot, `.${namespace}/scripts/index.js`);
  return require(location)(ctx);
};
