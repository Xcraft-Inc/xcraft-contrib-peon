...
var proceed = function (data, extra, callback, proceedCb) {
  ...
  async.series ([
    ...
    function (callback) {
      ...
      var rc = interpreter.run (extra.deploy);
 ...
 */
exports.onlyInstall = function (getObj, root, share, extra, callback, proceedCb) {
  utils.prepare (getObj, root, share, extra, function (err, data) {
    if (err) {
      callback (err);
    } else {
 ...
 */
exports.onlyBuild = function (getObj, root, share, extra, callback, proceedCb) {
 ...
 * This function must not be used with src backends.
 */
exports.always = function (getObj, root, share, extra, callback, proceedCb) {
